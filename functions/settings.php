<?php class apollo_launchpad_settings
{
	...
	function apollo_menu() {
		$this->pagehook = add_object_page( 'Launchpad', 'Launchpad', 'administrator', 'apollo_general_settings', array(&$this, 'apollo_display'), 'http://oboxthemes.com/images/ocmx-favicon.png' );
	}
